...
void main() {
  ...
  */
  ...
  /*
        ...
        const name = ‘Murtaza ';
        message += name; // 'Hello my name is Murtaza'
 
        final message = StringBuffer();
        message.write('Hello');
        message.write(' my name is ');
        message.write('Murtaza');
        message.toString(); // "Hello my name is Murtaza"
  ...
  */
  ...
  /*
        ...
        const name = "Murtaza";
        const intro = "Hello , My name is $name"; //Hello my name is Murtaza
  ...
  */
  /*
        //Mini-Exercises
          ...
          const lastname = "Mister";
 
          //2.
          const fullname = firstname + lastname; // fullname = Murtaza Mister
 
          //3.
          const mydetail = " Hello , My name is $fullname"; // mydetail = "Hello, My name is Murtaza Mister"
  */
  /*
